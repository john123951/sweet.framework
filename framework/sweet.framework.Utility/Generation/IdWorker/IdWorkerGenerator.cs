...
namespace sweet.framework.Utility.Generattion
{
    public class IdWorkerGenerator
    {
        ...
        public IdWorkerGenerator(long workerId, long datacenterId, long sequence = 0L)
        {
        ...
        public virtual long NextId()
        {
            ...
            lock (this._lock)
            {
                ...
                {
                    throw new Exception(string.Format("Clock moved backwards.  Refusing to generate id for {0} milliseconds", this._lastTimestamp - num));
                }
