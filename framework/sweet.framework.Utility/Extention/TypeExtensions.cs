...
namespace sweet.framework.Utility.Extention
{
    ...
    public static class TypeExtensions
    {
        ...
        {
            return source.IsGenericType && (typeof(Nullable<>) == source.GetGenericTypeDefinition());
        }
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static bool IsConcrete(this Type source)
        {
            return (!source.IsInterface && !source.IsAbstract && !source.IsValueType);
        }
