...
namespace sweet.framework.Utility.Extention
{
    ...
    public static class AsyncExtensions
    {
        ...
        private static Task GetActionTask(Action action)
        {
        ...
        private static Task GetActionTask(Action action, CancellationToken token)
        {
        ...
        private static Task GetActionTask(Action action, TaskCreationOptions options)
        {
        ...
        private static Task GetTask(Action action, CancellationToken token, TaskCreationOptions options)
        {
        ...
        private static Task<T> GetTask<T>(Func<T> func)
        {
        ...
        private static Task<T> GetTask<T>(Func<T> func, TaskCreationOptions options)
        {
        ...
        private static Task<T> GetTask<T>(Func<T> func, CancellationToken token, TaskCreationOptions options)
        {
        ...
        #endregion SingleOrDefaultAsync
